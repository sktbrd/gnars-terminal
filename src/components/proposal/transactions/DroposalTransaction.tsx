...
export default function DroposalTransaction({ calldata, index }: DroposalTransactionProps) {
    let decodedData:
        | {
            name: string;
            symbol: string;
    ...
    if (!decodedData) {
        return (
            <Box p={4} borderWidth={1} rounded="md" shadow="sm" mb={4}>
                ...
                <Text color="red.500">Failed to decode transaction data. Unsupported signature.</Text>
            ...
            <VStack align="start" gap={3}>
                ...
                <Text>
                    ...
                    {decodedData.imageURI ? (
                        <img src={decodedData.imageURI} alt="Droposal Image" style={{ maxWidth: '100%' }} />
                    ) : (
                        'N/A'
                    )}
                </Text>
